...
const Testimony = () => {
  ...
  return (
    <div className="w-full bg-gray lg:px-[10rem] xl:px-[12rem]">
      <div className="py-[4rem] px-[1.6rem]">
        ...
        <h3 className="text-montserrat-16 leading-[2.56rem] text-text/[.6] pt-[1.6rem] md:m-auto md:w-[80%] md:text-center">
          Our customers love our food and friendly vibe! Discover why we’re the
          top choice for El Salvadoran breakfast and lunch.
        </h3>
                  ...
                  <CardContent className="flex flex-col gap-[2.4rem] p-0">
                    <div className="flex gap-[1.6rem] items-center">
                      <Image
                        ...
                        src={require(`../../../public/images/${testimony.user_image}`)}
                    ...
                    <div className="flex gap-[1.6rem] items-center">
                      ...
                      <Image
                        ...
                        src={require(`../../../public/images/${testimony.posted_on}`)}
