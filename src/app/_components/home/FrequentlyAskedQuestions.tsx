...
const FrequentlyAskedQuestions = () => {
  return (
    <div className="py-[4rem] px-[1.6rem] w-full md:py-[6rem] md:px-[4rem] lg:px-[10rem] xl:px-[12rem]">
      <h2 className="flex text-montserrat-28 font-bold md:m-auto md:justify-center">
        ...
        <Card className="bg-gray border-none">
          <CardContent className="flex flex-col gap-[2.4rem] pt-6">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-montserrat-16 font-bold leading-[2.58rem]">
                Can I book a table in advance?
              </AccordionTrigger>
              <AccordionContent>
                <p className="text-montserrat-14 text-text/[.6] pt-[2.8rem] leading-[2.2rem]">
        ...
        <Card className="bg-gray border-none">
          <CardContent className="flex flex-col gap-[2.4rem] pt-6">
            <AccordionItem value="item-4">
              ...
              <AccordionContent>
                <p className="text-montserrat-14 text-text/[.6] pt-[2.8rem] leading-[2.2rem]">
                  We do have a free Wi-Fi available exclussively for customers.
                  It’s fast enough for you to work from our café!
                </p>
              </AccordionContent>
            </AccordionItem>
          </CardContent>
        ...
        <Card className="bg-gray border-none">
          <CardContent className="flex flex-col gap-[2.4rem] pt-6">
            <AccordionItem value="item-5">
              ...
              <AccordionContent>
                <p className="text-montserrat-14 text-text/[.6] pt-[2.8rem] leading-[2.2rem]">
                  Yes, we welcome pets! Just make sure they don’t disturb other
                  customers or damage anything.
                </p>
              </AccordionContent>
            </AccordionItem>
          </CardContent>
